 ...
 * @author juan-
 */
public class Permisos_Dummy extends javax.swing.JFrame {
    ...
    public static Permisos_Dummy instance;

    public static Permisos_Dummy getInstance() {
        if (instance == null) {
            instance = new Permisos_Dummy();
        }
        return instance;
    }
        ...
        if (statement != null) {
            try {
                String sqlString = "UPDATE PERMISOS "
                        ...
                        + "WHERE user_id=" + user_id + " AND " + "app_id=" + 3 + " AND " + "rol_neg_id=" + rol_neg_id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Permisos_Dummy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Permisos_Dummy().setVisible(true);
            }
        });
    }
